...
""" Creates random test/training set
Creates binary numbers and shuffles them.
Converts Binary number to np.array()
Output_layer is how many 1's in input array,
    but in 'one hot encoded'
    3 = [0][0][0][1][0]...
    1 in array.position[3]
...
# Create Real Test/Training set

# Test set import using Pandas
